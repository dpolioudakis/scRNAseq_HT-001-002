...
# This script should be fed into 2_QC_and_Index_Mouse_QSUB.sh
...
fasta=/geschwindlabshares/CNTNAP2_RNAseq/damon/mouseRefGenome/GRCm38.p4.genome.fa
refFlat=/geschwindlabshares/CNTNAP2_RNAseq/damon/mouseRefGenome/refFlat.picard.gencode.vM8.txt
