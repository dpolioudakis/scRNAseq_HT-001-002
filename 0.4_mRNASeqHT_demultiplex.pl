...
# DP Edits
# 	Changed sub demultiplex so that entire R1 sequence is output
#		Input and Output directory format must include trailing slash
#			Ex: ../data/fastq/SxaQSEQsXap096L2/fastq_not_demultiplexed/
