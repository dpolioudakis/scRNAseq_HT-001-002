...
# This script is meant to be fed into 1_FQC_StarAlign_NoERCC_QSUB_NoERCC.sh
################################################################################
echo ""
echo "Starting 1_FQC_StarAlign_NoERCC.sh... "$(date)
################################################################################
...
STAR_INDEX=/geschwindlabshares/RNAseq_singlecellfetal/source/IndexedGenome_GRCh37.75_NoERCC
...
echo ""
echo "End of 1_FQC_StarAlign_NoERCC.sh... "$(date)
