...
################################################################################
echo ""
echo "Starting 4_HTSC_Expression_Mouse.sh... "$(date)
################################################################################
...
gtf=/geschwindlabshares/CNTNAP2_RNAseq/damon/mouseRefGenome/gencode.vM8.annotation.gtf
...
echo ""
echo "End of 4_HTSC_Expression_Mouse.sh... "$(date)
