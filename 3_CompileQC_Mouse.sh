...
# sh 3_CompileQC_Mouse.sh 2>&1 | tee logs/3_CompileQC_Mouse_$(date +%Y%m%d).log

# To submit via QSUB:
# qsub -cwd -V -N QC_comp -S /bin/bash -q geschwind.q -l h_data=16G,h_rt=3:00:00 3_CompileQC_Mouse.sh
