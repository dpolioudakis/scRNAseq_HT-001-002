...
colnames(datExpr) <- gsub("_exon_union_count.txt", "", as.character(algn$Sample.ID))
...
colnames(datExpr) <- gsub("_gene_union_count.txt", "", as.character(algn$Sample.ID))
