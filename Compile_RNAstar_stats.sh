...
#   sh Compile_RNAstar_stats.sh 2>&1 | tee logs/Compile_RNAstar_stats_$(date +%Y%m%d).log
################################################################################
echo ""
echo "Starting Compile_RNAstar_stats.sh..."$(date)
echo ""
################################################################################
...
echo ""
echo "End of Compile_RNAstar_stats.sh... "$(date)
