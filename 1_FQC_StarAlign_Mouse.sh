...
# This script is meant to be fed into 1_FQC_StarAlign_Mouse_QSUB.sh
################################################################################
echo ""
echo "Starting 1_FQC_StarAlign_Mouse.sh... "$(date)
################################################################################
...
STAR_INDEX=/geschwindlabshares/CNTNAP2_RNAseq/damon/mouseRefGenome/IndexedGenome
...
echo ""
echo "End of 1_FQC_StarAlign_Mouse.sh... "$(date)
